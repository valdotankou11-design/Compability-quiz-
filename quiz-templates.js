...
const QUIZ_TEMPLATES = [
  ...
  },
  {
    ...
    emoji: '💕',
    // Pas de "free: true" ici : ce lot reste réservé aux comptes Pro.
    questions: [
      { text: "Le langage de l'amour qui te touche le plus ?", options: ["Les mots doux et les compliments", "Le temps de qualité ensemble", "Les petites attentions / cadeaux", "Le contact physique (câlins, gestes tendres)"] },
      { text: "Face à un désaccord dans le couple, tu préfères...", options: ["En parler tout de suite, cash", "Laisser retomber la tension avant d'en discuter", "Écrire ce que tu ressens plutôt que d'en parler directement", "Éviter le sujet si possible"] },
      { text: "Ton rythme idéal entre temps ensemble et temps chacun de son côté ?", options: ["Presque tout le temps ensemble", "Un bon équilibre entre les deux", "Besoin de beaucoup de temps perso", "Ça dépend des périodes"] },
      { text: "La jalousie chez un partenaire, tu la vois plutôt comme...", options: ["Une preuve d'attachement, rassurante", "Acceptable à petite dose", "Un vrai frein, je fuis direct", "Je n'y ai jamais été confronté(e)"] },
      { text: "La famille dans une relation sérieuse, pour toi c'est...", options: ["Central, elle doit être intégrée à la relation", "Important mais garder une certaine distance", "Un sujet secondaire", "Je préfère garder les univers séparés"] },
      { text: "Se projeter à long terme (mariage, enfants, vie commune)...", options: ["Une évidence dont on peut parler tôt", "Oui, mais sans en faire une priorité immédiate", "Chaque chose en son temps, pas de plan fixe", "Je préfère ne pas trop y penser pour l'instant"] },
      { text: "L'humour dans le couple, ça doit être...", options: ["Présent tout le temps, même dans les moments sérieux", "Des petites piques taquines, du second degré", "Discret, je suis plus sérieux(se) de nature", "Ça dépend complètement du moment"] },
      { text: "La fidélité, pour toi, se définit comme...", options: ["Ne jamais regarder ailleurs, même en pensée", "Rester ensemble tout en gardant sa liberté d'esprit", "Une question de confiance mutuelle, pas de règle stricte", "Ça se discute selon le couple"] }
    ]
  }
];
